...
<ul>
	...
	<li><a class="text1" href="/hindi1">कला प्रकार</a></li>
	<li><a class "text1" href="/hindi2">सांस्कृतिक आयोजन</a></li>
 ...
 <li><a class="fa fa-download" href="/navkarthavyapath">कर्तव्य पथ</a></li>
	...
	<li>
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<a href="/updateUser/${ uUser }">प्रोफ़ाइल संपादित करें</a>
