...
<body>
    <div class="container">
        <div class="navbar">
            <div class="title">
                <div class="name">भारतीय संस्कृति प्रबंधन प्रणाली में आपका स्वागत है</div>
                
            </div>
            <div class="buttons">
               <a href="/hindi8" class="bn59">लॉगिन</a>
                <a class="bn59" href="/hindi9">रजिस्टर</a>
                <a class="bn59" href="/hindi7">हमारे बारे में</a>
                <a class="bn59" href="/contacthindi">संपर्क करें</a>
            <div class="bn3637">
        <button class="dropbtn"></button>
        <div class="dropdown-content">
            <a href="/" onclick="setLanguage('english')">English</a>
            <a href="hindi9" onclick="setLanguage('hindi')">हिंदी</a>
        </div>
