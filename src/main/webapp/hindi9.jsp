...
<head>
    ...
    <title>भारतीय संस्कृति प्रबंधन प्रणाली में आपका स्वागत है | Sign up</title>
...
<body>
    ...
    <form action="RegisterData" method="post">
        ...
        <div class="box">
        <h3 style="text-align: center; color:black;margin-top:10px;margin-bottom:10px;">साइन अप</h3>
       ...
       <input type = "submit" value="साइन अप" id="btn2"/>
